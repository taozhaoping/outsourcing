...
/*==============================================================*/
create global temporary table "SYS_RESOURCEINFO" 
(
   "id"                 NUMBER               not null,
...
/* Table: "sys_user"                                            */
/*==============================================================*/
create global temporary table "SYS_USER" 
(
   "id"                 NUMBER               not null,
   ...
   "phone"              VARCHAR2(1 BYTE), -- 座机号码
   "qq"                 VARCHAR2(1 BYTE), --qq号码
   "mobile_number"      VARCHAR2(1 BYTE), --手机号码
   "entryTime"          DATE, -- 入职时间
