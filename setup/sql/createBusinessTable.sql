...
(
   "id"                 NUMBER               not null,
   "contractType"       VARCHAR(20),        --合同种类
   公司电话号码               VARCHAR(20),  --公司电话号码
   工资卡银行                VARCHAR(20),   --工资卡银行
   工资卡号码                VARCHAR(30),   --工资卡号码
   工资                   NUMBER,           --工资
   合同开始日期               DATE,         --合同开始日期
   合同结束日期               DATE,         --合同结束日期 
   "TypeOfVisa"         VARCHAR(10),        --签证类型
   "TypeOfVisaDate"     DATE,               --签证到期日
   "SigningContractDate" DATE,              --合同正式签订日期
   "CopyToStaff"        VARCHAR(1),         --合同副本是否给外教
   "TechnologicalProcessID" NUMBER,         --人员ID
